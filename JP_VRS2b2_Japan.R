# VRS2b2 (estimate incidence with popEpi)
#
# 1. ---- Initial settings ----
...
rate_result_file_name <- function(result_name, name) {
  paste0(name$subdir, name$municipality_id, "_VRS2b2_rate_", result_name, "_", name$municipality_name, ".csv")
}

# sir_result_file_name <- function(name) {
#   paste0(name$subdir, name$municipality_id, "_VRS2b2_sir_", name$municipality_name, ".csv")
# }

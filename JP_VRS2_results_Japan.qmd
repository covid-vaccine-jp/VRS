...
## 構成
グラフは、1.浜松市＋松戸市、2.浜松市、3.松戸市の順に示されている。それぞれ、IncidencePrevalenceとpopEpiによる同一の集計がされている。
分析は、
...
である。四半期別の集計では、標準誤差が大きすぎてグラフがつぶれていることがあるので、
ここでは示されていないが、評人誤差を含めないグラフも参考になる。

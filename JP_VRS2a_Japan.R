# VRS2a (estimate incidence with popEpi)
#
# 1. ---- 初期設定 ----
## 自治体固有の設定
municipality_id <- "JP"
...
rate_result_file_name <- function(result_name, name) {
  paste0(name$subdir, name$municipality_id, "_VRS2a_rate_", result_name, "_", name$municipality_name, ".csv")
}

# sir_result_file_name <- function(name) {
#   paste0(name$subdir, name$municipality_id, "_VRS2a_sir_", name$municipality_name, ".csv")
# }
